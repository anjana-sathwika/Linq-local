...
export default function Hero() {
  ...
  <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold max-w-xl sm:max-w-3xl leading-tight text-gray-900 text-center mx-auto">
        ...
        <p className="mt-3 sm:mt-6 text-gray-600 max-w-md sm:max-w-2xl mx-auto text-base sm:text-lg">
          ...
          <span className="text-[#2F5EEA] font-semibold">30K+ followers</span> and{" "}
          <span className="text-[#2F5EEA] font-semibold">5K daily active users</span> 
        ...
        <Link href="https://forms.gle/EK6ScmSd65bBH2X5A" passHref>
          <button className="mt-5 sm:mt-10 bg-[#2F5EEA] text-white font-semibold px-8 sm:px-10 py-3 sm:py-4 rounded-full hover:bg-[#1E3FAE] transition">
            JOIN FOR FREE
          </button>
        </Link>
